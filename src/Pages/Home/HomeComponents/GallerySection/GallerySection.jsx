...
const GallerySection = () => {
    return (
        <div className='grid grid-cols-4 text-[#380B0B] gap-8'>
            ...
            <div className='bg-[#FFF8EE]'>
                ...
                <div className='text-end mt-8 mr-2'>
            ...
            <div className='row-span-2 bg-[#FFF8EE] relative overflow-hidden'>
            ...
            <div className='bg-[#FFF8EE] relative h-[250px]'>
                <div className='mt-4 ml-2'>
                    <h1 className='text-2xl font-black '>Supper Combo Burger</h1>
                    <button className='bg-[#c33] font-bold btn border-none mt-3 text-white uppercase'>Order Now</button>
                </div>
