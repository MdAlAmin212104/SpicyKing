...
const Footer = () => {
      return (
            <footer className="px-4 divide-y bg-gray-800 text-gray-100 mt-6">
                  <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                        <div className="lg:w-1/3">
                              <Link to='/' rel="noopener noreferrer" className="flex justify-center space-x-3 lg:justify-start">
                                    ...
                                    <span className="self-center text-2xl font-semibold">SpicyKing</span>
                              </Link>
                        </div>
                        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                              ...
                              <div className="space-y-3">
                                    <h3 className="tracking-wide uppercase dark:text-gray-300">Company</h3>
                                    <ul className="space-y-1">
                                          <li>
                              ...
                              <div className="space-y-3">
                                    <h3 className="uppercase dark:text-gray-300">Developers</h3>
                                    <ul className="space-y-1">
                                          <li>
                  ...
                  <div className="py-6 text-sm text-center dark:text-gray-300">© {moment().format('YYYY') } SpicyKing Co. All rights reserved.</div>
            </footer>
      );
};
