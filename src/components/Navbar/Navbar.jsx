...
const Navbar = () => {
      ...
      const links = <>
            ...
            <li><NavLink to='/gallery'>ABOUT US</NavLink></li>
            <li><NavLink to='/gallery'>MENU</NavLink></li>
            <li><NavLink to='/gallery'>BLOG</NavLink></li>
            <li><NavLink to='/gallery'>CONTACT US</NavLink></li>
      </>
